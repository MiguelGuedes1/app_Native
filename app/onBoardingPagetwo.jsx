...
export default function OnBoardingPageTwo() {
  const goToNextPage = () => {
    router.push("/onBoardingPagethree"); 
  };
      ...
      >
        <View className="w-full flex justify-center items-center h-full px-4">
          ...
          <Text className="text-center font-pregular text-sm text-gray-100 mb-8">
            Our platform connects you with experienced real estate consultants
            who can help you find the best deals and maximize your opportunities.
          </Text>
